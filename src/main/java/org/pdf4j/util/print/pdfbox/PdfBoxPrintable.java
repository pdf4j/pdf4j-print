 ...
 * @author Uma
 */
public class PdfBoxPrintable implements Printable {
     ...
     */
    public PdfBoxPrintable(PDDocument document)
    {
     ...
     */
    public PdfBoxPrintable(PDDocument document, Scaling scaling)
    {
     ...
     */
    public PdfBoxPrintable(PDDocument document, Scaling scaling, boolean showPageBorder)
    {
     ...
     */
    public PdfBoxPrintable(PDDocument document, Scaling scaling, boolean showPageBorder, float dpi)
    {
